...
DROP TABLE Thxtay_Chat_Message CASCADE CONSTRAINTS;
DROP TABLE Thxtay_Chat_Room CASCADE CONSTRAINTS;
...
CREATE SEQUENCE Thxtay_LODGING
    START WITH 10000
    MINVALUE 10000
    MAXVALUE 19999
    NOCACHE;

CREATE SEQUENCE Thxtay_Price
    START WITH 20000
    MINVALUE 20000
    MAXVALUE 29999
    NOCACHE;

CREATE SEQUENCE Thxtay_Booking
    START WITH 30000
    MINVALUE 30000
    MAXVALUE 39999
    NOCACHE;

CREATE SEQUENCE Thxtay_Payment
    START WITH 40000
    MINVALUE 40000
    MAXVALUE 49999
    NOCACHE;